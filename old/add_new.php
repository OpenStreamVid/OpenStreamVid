<div id="add_new" class="reveal-modal" data-reveal >
	<div class="content-wrap">
		<form id="content-form" method="POST" action="content.php" enctype="multipart/form-data">
			<fieldset>
				...
				<label data-tooltip class="has-tip form-label" 	title="Choose the tag linked to your content."> Content's tag <small>required</small> :
					...
					<?php 
						...
						foreach ($row as $key => $value) {
							echo '<option value="'. $value['tagid'] .'">'. $value['tagname'] .'</option>';
						}
					?>
					</select>
				</label>
				...
				<label class="form-label" id="content" for="content">Finally, upload your content (.mp4 / 2Go max) :<br>
					<!--	<input type="hidden" name="<?php /*echo ini_get('session.upload_progress.name');*/ ?>" value="upload_progress"> -->
					<input type="file" name="content" data-max-size="2147483648" accept="video/mp4" id="content-upload"/>
				</label>
				...
				<div class="form-button">
					<a id="submit-content" class="button radius">Add<a/>
