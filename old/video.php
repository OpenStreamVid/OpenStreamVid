...
<?php 
	...
	include "controller/ControllerVideo.php";
?>
...
<div id="content">
	<center>
		<div id="video-content">	
			<video id="<?php echo $_GET['content'] ?>" class="video-js vjs-default-skin vjs-big-play-centered" resolutions controls preload="auto" height="576" width="1024" data-setup='{"example_option":true}'>
				<source src="videos/<?php echo $value['usernickname'] ?>/<?php echo $_GET['content'] ?>/<?php echo $value['contenttitle'] ?>.mp4" type='video/mp4' data-res="HD"/>
				<track kind="captions" src="Videos/sub_en.vtt" srclang="en" label="English"></track>
...
<div id="content-header" class="content-block">
	...
	<div id="user-content">
		...
		<a href="channel.php?type=user&id=<?php echo $value['usernickname']; ?>"><img src="img/user/<?php echo $value['usernickname']; ?>/profile.jpg" height="50" width="50">
		<b><?php echo $value['usernickname']; ?></b></a>
	</div>
<?php if(isset($value['licencename']) && $value['licencename'] != 'Copyright'){ ?>
		<div id="content-button">
			<a href="videos/<?php echo $value['usernickname'] ?>/<?php echo $_GET['content'] ?>/<?php echo $value['contenttitle'] ?>.mp4" download="<?php echo $value['contenttitle'] ?>.mp4" class="button" id="download-btn">Download video</a>
		</div>
<?php } ?>
	...
	<div class="panel" id="description-panel">
		...
		<table id="content-info">
			...
			<tr>
				...
				<td><?php echo $value['licencename'] ?> <img src="img/site/<?php echo $value['licencename'] ?>.png" height="80" width="80"></td>
				<?php }else{ ?>
...
<script src="video-js/video-js-resolutions/video-js-resolutions.js"></script>

<?php 
	include 'include/include.js.php';
	include 'js/video.js.php'
?>