<script src="<?php echo WEBROOT . 'js/add-new-modal.js'; ?>"></script>
<script src="<?php echo WEBROOT . 'js/edit-content-modal.js'; ?>"></script>
<script src="<?php  echo WEBROOT . 'js/edit-user-modal.js'; ?>"></script>
<script type="text/javascript ?>">

	$(document).ready(function()
	{
		$.ajax({
			url:<?php ROOT ?>'controller/user.php',
			dataType:'json',
			type:'GET',
			data:'action=email&id='+<?php print $_SESSION['id'] ?>,
			success:function(data)
			{
				$('#change-email').append('<b>'+ data +'</b> <small>modify</small>');
...
**/
	...
	**/
	...
	$("#account-picture").click(function(e)
	{
		...
		if($(' #password.change').css('display')=='block')
		{
